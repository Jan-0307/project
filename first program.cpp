...
Description : A simple game of cricket comprising two innings
*/
#include<iostream>
#include<string>
#include<time.h>
...
int total_runs = 0;
srand(time(NULL));
cout << "Ball t t" << "Ru ns" << endl;
for(int i = 0; i< 6; i++) {
int run = rand()%7;
cout << i+1 << " t t" << run << endl;
total_runs += run;
sleep(2);
}
return total_runs;
...
cout << "Total Runs scored by " << team  << ": t t" << total_runs << endl;
}
